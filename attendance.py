...
class Attendance:
    def __init__(self, root):
        ...
        # First image
        img = Image.open(r"C:\Users\Dell\Desktop\college_images\smart-attendance.jpg")
        img = img.resize((1000, 200), Image.ANTIALIAS if 'ANTIALIAS' in dir(Image) else Image.BICUBIC)
        self.photoimg = ImageTk.PhotoImage(img)

        f_lbl1 = Label(self.root, image=self.photoimg)
        f_lbl1.place(x=0, y=0, width=1000, height=200)

        # Second image
        img1 = Image.open(r"C:\Users\Dell\Desktop\college_images\facial-recognition_0.jpg")
        img1 = img1.resize((1000, 250), Image.ANTIALIAS if 'ANTIALIAS' in dir(Image) else Image.BICUBIC)
        self.photoimg1 = ImageTk.PhotoImage(img1)

        f_lbl2 = Label(self.root, image=self.photoimg1)
        f_lbl2.place(x=800, y=0, width=1000, height=200)

        # Background image
        img3 = Image.open(r"c:\Users\Dell\Desktop\college_images\dev.jpg")
        ...
        img_left = Image.open(r"C:\Users\Dell\Desktop\college_images\face-recognition.png")
        ...
        save_btn=Button(btn_frame,text="Import csv",command=self.importCsv,width=17, font=("times new roman",13,"bold"),bg="pink",fg="black")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="Export csv",command=self.exportCsv, width=17, font=("times new roman",13,"bold"),bg="pink",fg="black")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,text="Update",width=17, font=("times new roman",13,"bold"),bg="pink",fg="black")
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(btn_frame,text="Reset",width=17,command = self.reset_data,  font=("times new roman",13,"bold"),bg="pink",fg="black")
