#@"C:\Program Files\Python312\python.exe" "c:\Users\Dell\Proj\student.py"
...
class Student:
    def __init__(self, root):
        ...
        # ============variables=============
        #StringVar is a class in Tkinter that is used to create Tkinter variable objects of type String
        ...
        # First image
        img = Image.open(r"C:\Users\Dell\Proj\PROJECT\college_images\face-recognition.png")
        ...
        # Second image
        img1 = Image.open(r"C:\Users\Dell\Proj\PROJECT\college_images\smart-attendance.jpg")
        ...
        # Third image
        img2 = Image.open(r"C:\Users\Dell\Proj\PROJECT\college_images\iStock-182059956_18390_t12.jpg")
        ...
        # Background image
        img3 = Image.open(r"C:\Users\Dell\Proj\PROJECT\college_images\wp2551980.jpg")
        ...
        main_frame.place(x=10,y=58,width=1520,height=700)

        #left label frame
        Left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=730,height=580)

        img_left = Image.open(r"C:\Users\Dell\Proj\PROJECT\college_images\AdobeStock_303989091.jpeg")
        img_left = img_left.resize((720, 130), Image.ANTIALIAS if 'ANTIALIAS' in dir(Image) else Image.BICUBIC)
        ...
        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dep,font=("times new roman",12,"bold"),state="readonly",width=23)
        ...
        course_combo["values"]=("Select Course","BE","MBA","PhD","ME")
        ...
        semester_combo["values"]=("Select Semeseter","Semester-1","Semester-2","Semester-3","Semester-4")
        ...
        class_div_entry=ttk.Entry(class_Student_frame,textvariable=self.var_roll,width=20,font=("times new roman",13,"bold"))
       ...
       #radio Buttons
        ...
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take a photo sample",width=70,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right = Image.open(r"C:\Users\Dell\Proj\PROJECT\college_images\gettyimages-1022573162.jpg")
        img_right = img_right.resize((720, 130), Image.ANTIALIAS if 'ANTIALIAS' in dir(Image) else Image.BICUBIC)
        ...
        table_frame.place(x=5,y=150,width=710,height=400)
...
# ================update function================
    def update_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                Update=messagebox.askyesno("Upate","Do you want to update Student details",parent= self.root)
                if Update > 0:
                    conn=mysql.connector.connect(host="localhost", username="root",password="RSSBsim26@tu#",database="project")
                    my_cursor=conn.cursor()
    ...
    def delete_data(self):
        if self.var_std_id.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Delte","Student details successfully deleted", parent=self.root)
            except Exception as es:
                messagebox.showerror("Error", f"Due To:{str(es)}",parent=self.root)
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:             
                ...
                #===========Load predefines data on face frontals from opencv==========
